      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-16 items-center">
          ...
          <div className="hidden md:flex items-center space-x-4">
            ...
            <Link href="/cart" className="relative p-2 text-gray-700 dark:text-gray-200 hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors">
                ...
                {user ? (
                  <div className="relative group">
                    ...
                    <div className="absolute right-0 mt-2 w-48 bg-white dark:bg-gray-800 rounded-lg shadow-lg border border-gray-200 dark:border-gray-700 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 transform origin-top-right">
                      <div className="py-2">
                        <Link href="/cart" className="block px-4 py-2 text-gray-800 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-700">
                          My Cart
                        </Link>
                        <button
                          onClick={logout}
                  ...
                  <div className="flex items-center space-x-3">
                    <Link href="/login" className="text-gray-700 dark:text-gray-200 hover:text-indigo-600 dark:hover:text-indigo-400 font-medium transition-colors">
                      Login
                    </Link>
        ...
        <div className="md:hidden bg-white dark:bg-gray-900 border-t border-gray-200 dark:border-gray-700">
          <div className="px-4 py-3 space-y-3">
            ...
            <div className="flex items-center space-x-4 pt-3 border-t border-gray-200 dark:border-gray-700">
              <ThemeToggle />
              <Link href="/cart" className="relative p-2 text-gray-700 dark:text-gray-200">
                <ShoppingCartIcon className="w-6 h-6" />
                {cartItemCount > 0 && (
                  <span className="absolute -top-1 -right-1 bg-indigo-600 text-white text-xs w-5 h-5 rounded-full flex items-center justify-center">
                    {cartItemCount}
              ...
              {!loading && !user && (
                <div className="flex space-x-3">
                  <Link href="/login" className="text-gray-700 dark:text-gray-200 font-medium">
                    Login
                  </Link>
